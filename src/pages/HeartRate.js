...
import HeartRateTable from '../components/HeartRateTable/HeartRateTable'
import FormValidation from '../utils/FormValidation'
import MaxHeartRate from '../utils/MaxHeartRate'
import Ad from '../components/Ad/Ad';
import chestStrapImg from '../assets/calculationImg/img/aa-chest-strap-heartrate.jpg'
  ...
  render() {
    return (
      <div className="container-960">
        <center><h1>Target Heart Rate</h1></center>&nbsp;
          ...
          <div className="col-sm-6">
            <form className="form-horizontal clearfix bottom-buffer" onSubmit={this.handleSubmit}>
              ...
              <div className="pull-right">
                <center><button type="submit" disabled={!this.canBeSubmitted()} className="btn btn-default">Submit</button></center>
              &nbsp;</div>
            </form>
          </div>
